...
const TripJoinViaEmail: React.FC = () => {
  ...
  useEffect(() => {
    if (credential && status === JoinStatus.TOKEN_VALID) {
  ...
  const redirectToLogin = () => {
    // Store the trip invitation info in localStorage so we can retrieve it after auth
    ...
    const returnUrl = `/trips/plan/${tripId}`;
    navigate(
