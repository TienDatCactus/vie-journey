  ...
  return (
    <HideOnScroll>
      <AppBar
        ...
        color="default"
        elevation={4}
        className=" shadow-sm border-b border-neutral-300  px-4 py-2 bg-neutral-50 text-white"
      >
        <Stack
          direction="row"
        ...
        >
          ...
          <Stack direction={"row"} alignItems="center" gap={1}>
            ...
            <Button
              ...
              variant="contained"
              className="rounded-full text-sm font-semibold px-4 py-2 bg-dark-800  text-white"
            >
              Get app
            </Button>
            <IconButton
