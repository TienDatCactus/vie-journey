...
const Itinerary: React.FC<ItineraryProps> = (props) => {
  ...
  useEffect(() => {
    if (startDate && endDate) {
      ...
      const fakeDates = getDatesBetween(
        new Date("2025-10-01"),
        new Date("2025-10-10")
      );
      setDates(fakeDates);
          ...
          {!!dates?.length &&
            ...
            plantations and wildlife.
                      ...
                      <p className="italic text-xs text-gray-600 font-semibold">
                        ...
                        Corrupti, velit quibusdam corporis doloremque, ea
                        voluptates quaerat ipsam odio exercitationem eligendi
                        facilis voluptatem asperiores dolor officia eaque beatae
                        eius deleniti odit!
                      </p>
                      <Stack
                        direction="row"
